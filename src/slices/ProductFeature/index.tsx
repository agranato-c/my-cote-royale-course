  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-3 lg:grid-rows-[auto,auto]">
        ...
        <FadeIn className="translate-y-16 opacity-0 lg:col-span-2 lg:row-span-2"
          vars={{ duration: 1 }}
          start="top 70%"
        >
          <PrismicNextImage
        ...
        >
          ...
          <PrismicNextImage field={fragrance?.data.bottle_image}
          ...
          <div className="flex justify-between p-10 pt-4">
            <div className="space-y-1">
              ...
              <p className="mt-2 text-gray-400"> Eau de Parfum
